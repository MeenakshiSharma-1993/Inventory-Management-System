...
<body>
    <div class="container">
        ...
        <div class="main">
            ...
            if (in_array("product-view", $permission_values)) { ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (in_array("product-edit", $permission_values)) { ?>
                                                    <a
                                                        href="#"
                                                        class="editBtn"
                                                        data-id="<?= $product['id']; ?>"
                                                ...
                                                <?php }
                                                if (in_array("product-delete", $permission_values)) {
            ...
            <?php } else {
                $errMsg = "You Do not have permission to View product.";
            }
